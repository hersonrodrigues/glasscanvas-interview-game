...
var import_jsx_runtime = require("react/jsx-runtime"), import_react = __toESM(require("react")), import_react_native_web_internals = require("react-native-web-internals"), import_Dimensions = __toESM(require("../Dimensions/index")), import_View = __toESM(require("../View/index")), import_ScrollViewBase = __toESM(require("./ScrollViewBase"));
...
var emptyObject = {}, IS_ANIMATING_TOUCH_START_THRESHOLD_MS = 16, ScrollView = /* @__PURE__ */ function(_React_Component) {
  ...
  var _super = _create_super(ScrollView2);
  function ScrollView2() {
    _class_call_check(this, ScrollView2);
    var _this;
    return _this = _super.apply(this, arguments), _define_property(_assert_this_initialized(_this), "_scrollNodeRef", void 0), _define_property(_assert_this_initialized(_this), "_innerViewRef", void 0), _define_property(_assert_this_initialized(_this), "keyboardWillOpenTo", null), _define_property(_assert_this_initialized(_this), "additionalScrollOffset", 0), _define_property(_assert_this_initialized(_this), "isTouching", !1), _define_property(_assert_this_initialized(_this), "lastMomentumScrollBeginTime", 0), _define_property(_assert_this_initialized(_this), "lastMomentumScrollEndTime", 0), _define_property(_assert_this_initialized(_this), "observedScrollSinceBecomingResponder", !1), _define_property(_assert_this_initialized(_this), "becameResponderWhileAnimating", !1), _define_property(_assert_this_initialized(_this), "scrollResponderScrollNativeHandleToKeyboard", function(nodeHandle, additionalOffset, preventNegativeScrollOffset) {
    ...
    }), _define_property(_assert_this_initialized(_this), "scrollResponderInputMeasureAndScrollToKeyboard", function(left, top, width, height) {
  ...
  return _create_class(ScrollView2, [
      ...
      */
      ...
      value: function(y, x, animated) {
        if (typeof y == "number")
          ...
          var ref;
          ref = y || emptyObject, x = ref.x, y = ref.y, animated = ref.animated;
        }
    ...
    },
    {
      ...
      */
      ...
      value: function(options) {
        var animated = (options && options.animated) !== !1, horizontal = this.props.horizontal, scrollResponder = this.getScrollResponder(), scrollResponderNode = this._scrollNodeRef, x = horizontal ? scrollResponderNode.scrollWidth : 0, y = horizontal ? 0 : scrollResponderNode.scrollHeight;
    ...
    },
    {
      key: "render",
      value: function() {
        var _this_props = this.props, contentContainerStyle = _this_props.contentContainerStyle, horizontal = _this_props.horizontal, onContentSizeChange = _this_props.onContentSizeChange, refreshControl = _this_props.refreshControl, stickyHeaderIndices = _this_props.stickyHeaderIndices, pagingEnabled = _this_props.pagingEnabled, forwardedRef = _this_props.forwardedRef, keyboardDismissMode = _this_props.keyboardDismissMode, onScroll = _this_props.onScroll, centerContent = _this_props.centerContent, other = _object_without_properties(_this_props, [
        ...
        if (process.env.NODE_ENV !== "production" && this.props.style) {
          ...
          (0, import_react_native_web_internals.invariant)(childLayoutProps.length === 0, "ScrollView child layout (".concat(JSON.stringify(childLayoutProps), ") ") + "must be applied through the contentContainerStyle prop.");
        }
        ...
        var hasStickyHeaderIndices = !horizontal && Array.isArray(stickyHeaderIndices), children = hasStickyHeaderIndices || pagingEnabled ? import_react.default.Children.map(this.props.children, function(child, i) {
        ...
        }) : this.props.children, contentContainer = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_View.default, _object_spread_props(_object_spread({}, contentSizeChangeProps), {
          // @ts-ignore
          collapsable: !1,
          ...
          children
        })), baseStyle = horizontal ? styles.baseHorizontal : styles.baseVertical, pagingEnabledStyle = horizontal ? styles.pagingEnabledHorizontal : styles.pagingEnabledVertical, props = _object_spread_props(_object_spread({}, other), {
          style: [
            baseStyle,
        ...
        var scrollView = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ScrollViewClass, _object_spread_props(_object_spread({}, props), {
      ...
      */
      ...
      value: function(x, y, animated) {
        if (typeof x == "number")
          ...
          var ref;
          ref = x || emptyObject, x = ref.x, y = ref.y, animated = ref.animated;
        }
  ...
  baseVertical: _object_spread_props(_object_spread({}, commonStyle), {
    flexDirection: "column",
    overflowX: "hidden",
    overflowY: "auto"
  }),
  baseHorizontal: _object_spread_props(_object_spread({}, commonStyle), {
    flexDirection: "row",
    overflowX: "auto",
    overflowY: "hidden"
  }),
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ScrollView, _object_spread_props(_object_spread({}, props), {
    forwardedRef
  }));
});

...
var import_react_native_web_internals = require("react-native-web-internals"), import_AnimatedEvent = require("../AnimatedEvent"), import_NativeAnimatedHelper = __toESM(require("../NativeAnimatedHelper")), import_AnimatedNode = __toESM(require("./AnimatedNode")), import_AnimatedStyle = __toESM(require("./AnimatedStyle"));
...
var AnimatedProps = /* @__PURE__ */ function(AnimatedNode1) {
  ...
  var _super = _create_super(AnimatedProps2);
  function AnimatedProps2(props, callback) {
    _class_call_check(this, AnimatedProps2);
    var _this;
    return _this = _super.call(this), props.style && (props = _object_spread_props(_object_spread({}, props), {
  ...
  return _create_class(AnimatedProps2, [
    {
      ...
      value: function() {
        ...
        for (var key in this._props) {
          ...
          _instanceof(value, import_AnimatedNode.default) ? (!value.__isNative || _instanceof(value, import_AnimatedStyle.default)) && (props[key] = value.__getValue()) : _instanceof(value, import_AnimatedEvent.AnimatedEvent) ? props[key] = value.__getHandler() : props[key] = value;
        }
        return props;
      }
    },
    {
      ...
      value: function() {
        ...
        for (var key in this._props) {
          var value = this._props[key];
          _instanceof(value, import_AnimatedNode.default) && (props[key] = value.__getAnimatedValue());
        }
        return props;
      }
    },
    ...
    },
    {
      ...
      value: function() {
        ...
        for (var propKey in this._props) {
          ...
          _instanceof(value, import_AnimatedNode.default) && (value.__makeNative(), propsConfig[propKey] = value.__getNativeTag());
        }
        return {
          type: "props",
          props: propsConfig
...
}(import_AnimatedNode.default), AnimatedProps_default = AnimatedProps;

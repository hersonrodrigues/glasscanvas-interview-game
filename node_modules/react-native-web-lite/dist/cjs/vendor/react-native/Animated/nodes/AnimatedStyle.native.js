...
function createAnimatedStyle(inputStyle) {
  ...
  for (var key in style) {
    var value = style[key];
    key === "transform" ? animatedStyles[key] = new import_AnimatedTransform.default(value) : _instanceof(value, import_AnimatedNode.default) ? animatedStyles[key] = value : value && !Array.isArray(value) && typeof value == "object" && (animatedStyles[key] = createAnimatedStyle(value));
  }
  return animatedStyles;
}
var AnimatedStyle = /* @__PURE__ */ function(AnimatedWithChildren2) {
  _inherits(AnimatedStyle2, AnimatedWithChildren2);
  var _super = _create_super(AnimatedStyle2);
  function AnimatedStyle2(style) {
    _class_call_check(this, AnimatedStyle2);
    var _this;
    return _this = _super.call(this), _this._inputStyle = style, _this._style = createAnimatedStyle(style), _this;
  }
  return _create_class(AnimatedStyle2, [
    {
      ...
      value: function(style) {
        ...
        for (var key in style) {
          var value = style[key];
          _instanceof(value, import_AnimatedNode.default) ? value.__isNative || (updatedStyle[key] = value.__getValue()) : value && !Array.isArray(value) && typeof value == "object" ? updatedStyle[key] = this._walkStyleAndGetValues(value) : updatedStyle[key] = value;
        }
        return updatedStyle;
      }
    },
    ...
    },
    {
      ...
      value: function(style) {
        ...
        for (var key in style) {
          var value = style[key];
          _instanceof(value, import_AnimatedNode.default) ? updatedStyle[key] = value.__getAnimatedValue() : value && !Array.isArray(value) && typeof value == "object" && (updatedStyle[key] = this._walkStyleAndGetAnimatedValues(value));
        }
        return updatedStyle;
      }
    },
    ...
    },
    {
      ...
      value: function() {
        for (var key in this._style) {
          ...
          _instanceof(value, import_AnimatedNode.default) && value.__addChild(this);
        }
      }
    },
    {
      ...
      value: function() {
        for (var key in this._style) {
          var value = this._style[key];
          _instanceof(value, import_AnimatedNode.default) && value.__removeChild(this);
        }
    ...
    },
    {
      ...
      value: function() {
        for (var key in this._style) {
          var value = this._style[key];
          _instanceof(value, import_AnimatedNode.default) && value.__makeNative();
        }
    ...
    },
    {
      ...
      value: function() {
        ...
        for (var styleKey in this._style)
          if (_instanceof(this._style[styleKey], import_AnimatedNode.default)) {
...
}(import_AnimatedWithChildren.default), AnimatedStyle_default = AnimatedStyle;

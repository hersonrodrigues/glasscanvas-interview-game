...
var AnimatedTransform = /* @__PURE__ */ function(AnimatedWithChildren2) {
  ...
  var _super = _create_super(AnimatedTransform2);
  function AnimatedTransform2(transforms) {
    _class_call_check(this, AnimatedTransform2);
    var _this;
    return _this = _super.call(this), _this._transforms = transforms || [], _this;
  }
    ...
    },
    {
      ...
      value: function() {
        return this._transforms.map(function(transform) {
          ...
          for (var key in transform) {
            var value = transform[key];
            _instanceof(value, import_AnimatedNode.default) ? result[key] = value.__getValue() : result[key] = value;
          }
          return result;
        });
      }
    },
    {
      ...
      value: function() {
        return this._transforms.map(function(transform) {
          ...
          for (var key in transform) {
            var value = transform[key];
            _instanceof(value, import_AnimatedNode.default) ? result[key] = value.__getAnimatedValue() : result[key] = value;
          }
          return result;
        });
      }
    },
    {
      ...
      value: function() {
        ...
        this._transforms.forEach(function(transform) {
          for (var key in transform) {
            var value = transform[key];
            _instanceof(value, import_AnimatedNode.default) && value.__addChild(_this);
          }
        });
      }
    },
    {
      ...
      value: function() {
        ...
        this._transforms.forEach(function(transform) {
          for (var key in transform) {
            var value = transform[key];
            _instanceof(value, import_AnimatedNode.default) && value.__removeChild(_this);
          }
    ...
    },
    {
      ...
      value: function() {
        ...
        return this._transforms.forEach(function(transform) {
          for (var key in transform) {
            var value = transform[key];
            _instanceof(value, import_AnimatedNode.default) ? transConfigs.push({
              type: "animated",
              property: key,

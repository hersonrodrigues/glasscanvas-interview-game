...
var import_react_native_web_internals = require("react-native-web-internals"), import_NativeAnimatedHelper = __toESM(require("../NativeAnimatedHelper")), import_AnimatedInterpolation = __toESM(require("./AnimatedInterpolation")), import_AnimatedWithChildren = __toESM(require("./AnimatedWithChildren"));
...
var AnimatedValue = /* @__PURE__ */ function(AnimatedWithChildren2) {
  ...
  var _super = _create_super(AnimatedValue2);
  function AnimatedValue2(value, config) {
    _class_call_check(this, AnimatedValue2);
    var _this;
    if (_this = _super.call(this), typeof value != "number")
      ...
      */
      ...
      value: function(animation, callback) {
        ...
        this._animation && this._animation.stop(), this._animation = animation, animation.start(
          ...
          /* flush */
          function(result) {
            _this._animation = null, handle !== null && import_react_native_web_internals.InteractionManager.clearInteractionHandle(handle), callback && callback(result);
          },
          previousAnimation,
          this
        );
...
}(import_AnimatedWithChildren.default), AnimatedValue_default = AnimatedValue;

...
var import_react_native_web_internals = require("react-native-web-internals"), import_AnimatedValue = __toESM(require("./AnimatedValue")), import_AnimatedWithChildren = __toESM(require("./AnimatedWithChildren"));
...
var _uniqueId = 1, AnimatedValueXY = /* @__PURE__ */ function(AnimatedWithChildren2) {
  ...
  var _super = _create_super(AnimatedValueXY2);
  function AnimatedValueXY2(valueIn) {
    ...
    return typeof value.x == "number" && typeof value.y == "number" ? (_this.x = new import_AnimatedValue.default(value.x), _this.y = new import_AnimatedValue.default(value.y)) : ((0, import_react_native_web_internals.invariant)(_instanceof(value.x, import_AnimatedValue.default) && _instanceof(value.y, import_AnimatedValue.default), "AnimatedValueXY must be initialized with an object of numbers or AnimatedValues."), _this.x = value.x, _this.y = value.y), _this._listeners = {}, _this;
  }
...
}(import_AnimatedWithChildren.default), AnimatedValueXY_default = AnimatedValueXY;

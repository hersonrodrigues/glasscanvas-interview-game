...
var import_normalize_css_color = __toESM(require("@tamagui/normalize-css-color")), import_NativeAnimatedHelper = __toESM(require("../NativeAnimatedHelper")), import_AnimatedValue = __toESM(require("./AnimatedValue")), import_AnimatedWithChildren = __toESM(require("./AnimatedWithChildren"));
...
var NativeAnimatedAPI = import_NativeAnimatedHelper.default.API, defaultColor = {
  r: 0,
  g: 0,
  b: 0,
  a: 1
...
function isRgbaAnimatedValue(value) {
  return value && _instanceof(value.r, import_AnimatedValue.default) && _instanceof(value.g, import_AnimatedValue.default) && _instanceof(value.b, import_AnimatedValue.default) && _instanceof(value.a, import_AnimatedValue.default);
}
var AnimatedColor = /* @__PURE__ */ function(AnimatedWithChildren2) {
  _inherits(AnimatedColor2, AnimatedWithChildren2);
  var _super = _create_super(AnimatedColor2);
  function AnimatedColor2(valueIn, config) {
    _class_call_check(this, AnimatedColor2);
    var _this;
    _this = _super.call(this), _this._listeners = {};
    ...
    if (isRgbaAnimatedValue(value)) {
      ...
      isRgbaValue(processedColor) ? initColor = processedColor : _this.nativeColor = processedColor, _this.r = new import_AnimatedValue.default(initColor.r), _this.g = new import_AnimatedValue.default(initColor.g), _this.b = new import_AnimatedValue.default(initColor.b), _this.a = new import_AnimatedValue.default(initColor.a);
    }

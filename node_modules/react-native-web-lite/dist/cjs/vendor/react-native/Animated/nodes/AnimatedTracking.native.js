...
var AnimatedTracking = /* @__PURE__ */ function(AnimatedNode2) {
  ...
  var _super = _create_super(AnimatedTracking2);
  function AnimatedTracking2(value, parent, animationClass, animationConfig, callback) {
    _class_call_check(this, AnimatedTracking2);
    var _this;
    return _this = _super.call(this), _this._value = value, _this._parent = parent, _this._animationClass = animationClass, _this._animationConfig = animationConfig, _this._useNativeDriver = (0, import_NativeAnimatedHelper.shouldUseNativeDriver)(animationConfig), _this._callback = callback, _this.__attach(), _this;
  }
  return _create_class(AnimatedTracking2, [
    ...
    },
    {
      key: "update",
      value: function() {
        this._value.animate(new this._animationClass(_object_spread_props(_object_spread({}, this._animationConfig), {
...
}(import_AnimatedNode.default), AnimatedTracking_default = AnimatedTracking;

...
var DecayAnimation = /* @__PURE__ */ function(Animation2) {
  ...
  var _super = _create_super(DecayAnimation2);
  function DecayAnimation2(config) {
    ...
    return _this = _super.call(this), _this._deceleration = (_config$deceleration = config.deceleration) !== null && _config$deceleration !== void 0 ? _config$deceleration : 0.998, _this._velocity = config.velocity, _this._useNativeDriver = (0, import_NativeAnimatedHelper.shouldUseNativeDriver)(config), _this.__isInteraction = (_config$isInteraction = config.isInteraction) !== null && _config$isInteraction !== void 0 ? _config$isInteraction : !_this._useNativeDriver, _this.__iterations = (_config$iterations = config.iterations) !== null && _config$iterations !== void 0 ? _config$iterations : 1, _this;
  }
...
}(_wrap_native_super(import_Animation.default)), DecayAnimation_default = DecayAnimation;

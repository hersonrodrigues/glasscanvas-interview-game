...
var EmitterSubscription = /* @__PURE__ */ function(_EventSubscription2) {
  ...
  var _super = _create_super(EmitterSubscription2);
  function EmitterSubscription2(emitter, subscriber, listener, context) {
    _class_call_check(this, EmitterSubscription2);
    var _this;
    return _this = _super.call(this, subscriber), _this.emitter = emitter, _this.listener = listener, _this.context = context, _this;
  }
...
}(import_EventSubscription.default), EmitterSubscription_default = EmitterSubscription;

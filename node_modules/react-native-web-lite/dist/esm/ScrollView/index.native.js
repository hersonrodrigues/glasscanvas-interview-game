...
import { Platform, StyleSheet, TextInputState, UIManager, dismissKeyboard, invariant, mergeRefs, warning } from "react-native-web-internals";
...
var emptyObject = {}, IS_ANIMATING_TOUCH_START_THRESHOLD_MS = 16, ScrollView = /* @__PURE__ */ function(_React_Component) {
  ...
  function ScrollView2() {
    ...
    return _this = _super.apply(this, arguments), _define_property(_assert_this_initialized(_this), "_scrollNodeRef", void 0), _define_property(_assert_this_initialized(_this), "_innerViewRef", void 0), _define_property(_assert_this_initialized(_this), "keyboardWillOpenTo", null), _define_property(_assert_this_initialized(_this), "additionalScrollOffset", 0), _define_property(_assert_this_initialized(_this), "isTouching", !1), _define_property(_assert_this_initialized(_this), "lastMomentumScrollBeginTime", 0), _define_property(_assert_this_initialized(_this), "lastMomentumScrollEndTime", 0), _define_property(_assert_this_initialized(_this), "observedScrollSinceBecomingResponder", !1), _define_property(_assert_this_initialized(_this), "becameResponderWhileAnimating", !1), _define_property(_assert_this_initialized(_this), "scrollResponderScrollNativeHandleToKeyboard", function(nodeHandle, additionalOffset, preventNegativeScrollOffset) {
      _this.additionalScrollOffset = additionalOffset || 0, _this.preventNegativeScrollOffset = !!preventNegativeScrollOffset, UIManager.measureLayout(nodeHandle, _this.options.getInnerViewNode(), _this.scrollResponderTextInputFocusError, _this.scrollResponderInputMeasureAndScrollToKeyboard);
    ...
    },
    {
      ...
      value: function() {
        ...
        if (process.env.NODE_ENV !== "production" && this.props.style) {
          ...
          invariant(childLayoutProps.length === 0, "ScrollView child layout (".concat(JSON.stringify(childLayoutProps), ") ") + "must be applied through the contentContainerStyle prop.");
        }
        ...
        }) : this.props.children, contentContainer = /* @__PURE__ */ _jsx(View, _object_spread_props(_object_spread({}, contentSizeChangeProps), {
          // @ts-ignore
          collapsable: !1,
        ...
        var scrollView = /* @__PURE__ */ _jsx(ScrollViewClass, _object_spread_props(_object_spread({}, props), {
  ...
  return /* @__PURE__ */ _jsx(ScrollView, _object_spread_props(_object_spread({}, props), {
    forwardedRef
  }));
});

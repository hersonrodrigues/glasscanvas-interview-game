...
var _uniqueId = 1, AnimatedValueXY = /* @__PURE__ */ function(AnimatedWithChildren2) {
  ...
  function AnimatedValueXY2(valueIn) {
    ...
    return typeof value.x == "number" && typeof value.y == "number" ? (_this.x = new AnimatedValue(value.x), _this.y = new AnimatedValue(value.y)) : (invariant(_instanceof(value.x, AnimatedValue) && _instanceof(value.y, AnimatedValue), "AnimatedValueXY must be initialized with an object of numbers or AnimatedValues."), _this.x = value.x, _this.y = value.y), _this._listeners = {}, _this;
  }

...
function createAnimatedStyle(inputStyle) {
  ...
  for (var key in style) {
    var value = style[key];
    key === "transform" ? animatedStyles[key] = new AnimatedTransform(value) : _instanceof(value, AnimatedNode) ? animatedStyles[key] = value : value && !Array.isArray(value) && typeof value == "object" && (animatedStyles[key] = createAnimatedStyle(value));
  }
  ...
  return _create_class(AnimatedStyle2, [
    {
      ...
      value: function(style) {
        ...
        for (var key in style) {
          var value = style[key];
          _instanceof(value, AnimatedNode) ? value.__isNative || (updatedStyle[key] = value.__getValue()) : value && !Array.isArray(value) && typeof value == "object" ? updatedStyle[key] = this._walkStyleAndGetValues(value) : updatedStyle[key] = value;
        }
        return updatedStyle;
      }
    },
    ...
    },
    {
      ...
      value: function(style) {
        ...
        for (var key in style) {
          var value = style[key];
          _instanceof(value, AnimatedNode) ? updatedStyle[key] = value.__getAnimatedValue() : value && !Array.isArray(value) && typeof value == "object" && (updatedStyle[key] = this._walkStyleAndGetAnimatedValues(value));
        }
        return updatedStyle;
      }
    },
    ...
    },
    {
      ...
      value: function() {
        for (var key in this._style) {
          ...
          _instanceof(value, AnimatedNode) && value.__addChild(this);
        }
      }
    },
    {
      ...
      value: function() {
        for (var key in this._style) {
          var value = this._style[key];
          _instanceof(value, AnimatedNode) && value.__removeChild(this);
        }
    ...
    },
    {
      ...
      value: function() {
        for (var key in this._style) {
          var value = this._style[key];
          _instanceof(value, AnimatedNode) && value.__makeNative();
        }
    ...
    },
    {
      ...
      value: function() {
        ...
        for (var styleKey in this._style)
          if (_instanceof(this._style[styleKey], AnimatedNode)) {

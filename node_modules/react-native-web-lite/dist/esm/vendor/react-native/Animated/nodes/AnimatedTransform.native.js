    ...
    },
    {
      ...
      value: function() {
        return this._transforms.map(function(transform) {
          ...
          for (var key in transform) {
            var value = transform[key];
            _instanceof(value, AnimatedNode) ? result[key] = value.__getValue() : result[key] = value;
          }
          return result;
        });
      }
    },
    {
      ...
      value: function() {
        return this._transforms.map(function(transform) {
          ...
          for (var key in transform) {
            var value = transform[key];
            _instanceof(value, AnimatedNode) ? result[key] = value.__getAnimatedValue() : result[key] = value;
          }
          return result;
        });
      }
    },
    {
      ...
      value: function() {
        ...
        this._transforms.forEach(function(transform) {
          for (var key in transform) {
            var value = transform[key];
            _instanceof(value, AnimatedNode) && value.__addChild(_this);
          }
        });
      }
    },
    {
      ...
      value: function() {
        ...
        this._transforms.forEach(function(transform) {
          for (var key in transform) {
            var value = transform[key];
            _instanceof(value, AnimatedNode) && value.__removeChild(_this);
          }
    ...
    },
    {
      ...
      value: function() {
        ...
        return this._transforms.forEach(function(transform) {
          for (var key in transform) {
            var value = transform[key];
            _instanceof(value, AnimatedNode) ? transConfigs.push({
              type: "animated",
              property: key,

...
var SpringAnimation = /* @__PURE__ */ function(Animation2) {
  ...
  var _super = _create_super(SpringAnimation2);
  ...
  return _create_class(SpringAnimation2, [
    ...
    },
    {
      ...
      value: function(fromValue, onUpdate, onEnd, previousAnimation, animatedValue) {
        var _this = this;
        if (this.__active = !0, this._startPosition = fromValue, this._lastPosition = this._startPosition, this._onUpdate = onUpdate, this.__onEnd = onEnd, this._lastTime = Date.now(), this._frameTime = 0, _instanceof(previousAnimation, SpringAnimation2)) {
